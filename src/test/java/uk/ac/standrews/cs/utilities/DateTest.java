...
public class DateTest {
    ...
    public void parseDates() throws ParseException {
        ...
        Date date = DateManipulation.parseDate("03 MAY 1966");

        assertEquals(3, DateManipulation.dateToDay(date));
        assertEquals(5, DateManipulation.dateToMonth(date));
        assertEquals(1966, DateManipulation.dateToYear(date));
    }

    @Test
    public void yearDifference() throws ParseException {

        Date date1 = DateManipulation.parseDate("03 MAY 2016");
        Date date2 = DateManipulation.parseDate("29 FEB 2020");

        assertEquals(3, DateManipulation.differenceInYears(date1, date2));
        assertEquals(-4, DateManipulation.differenceInYears(date2, date1));
        assertEquals(4, DateManipulation.differenceInCalendarYears(date1, date2));
    }
