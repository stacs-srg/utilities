...
public class ColorsFull90_10_NoTrace {
    ...
    private void addRow(DataSet data, String query, float threshold,  long count_ros, long count_calcs, long num_results) {

        data.addRow(query, Float.toString(threshold),Long.toString(count_ros), Long.toString(count_calcs), Long.toString(num_results));
    }
