 ...
 */
public class SparseDistribution implements Iterable<QgramDistribution> {
    ...
    public SparseDistribution(String x) {

        counting = true;

        for (final String s : StringMeasure.extractNGrams(x, 2)) {
            averageValue(s, 1);
        }
    }
     ...
     */
    public SparseDistribution(FeatureVector fv) {
     ...
     */
    public SparseDistribution(SparseDistribution source) {

        this.counting = source.counting;

        for (QgramDistribution q : source) {
            list.add(new QgramDistribution(q.key));
        }
    }
    ...
    public Iterator<QgramDistribution> iterator() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SparseDistribution)) return false;
        SparseDistribution that = (SparseDistribution) o;
    ...
    public static void main(String[] args) {
        ...
        SparseDistribution sd1 = new SparseDistribution("AABBABACVXSAB");
        System.out.println(sd1);

        SparseDistribution sd2 = new SparseDistribution("AABBABACVXSAB");
